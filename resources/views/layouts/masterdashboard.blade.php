...
<!-- Sidebar -->
  ...
  @can('peternakan')
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePeternakan" aria-expanded="true" aria-controls="collapsePeternakan">
          <i class="fas fa-fw fa-cog"></i>
          <span>Sektor Peternakan</span>
        </a>
        <div id="collapsePeternakan" class="collapse" aria-labelledby="headingPeternakan" data-parent="#accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePertanian" aria-expanded="true" aria-controls="collapsePertanian">
          <i class="fas fa-fw fa-cog"></i>
          <span>Sektor Pertanian</span>
        </a>
        <div id="collapsePertanian" class="collapse" aria-labelledby="headingPertanian" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
...
@can('koperasi')
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseEkonomi" aria-expanded="true" aria-controls="collapseEkonomi">
          <i class="fas fa-fw fa-cog"></i>
          <span>Sektor Ekonomi</span>
        </a>
        <div id="collapseEkonomi" class="collapse" aria-labelledby="headingEkonomi" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
